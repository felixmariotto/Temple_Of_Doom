...
function Atlas() {
	...
	const d0 = [ 2, 2, 2, 2,    1.75, 1.5,  1.25, 1,   0.5, 1, 0.75, 0.5, 0, 1,   2, 3,    4,   4, 4, 4, 10, 4, 10, 4, 10, 6,   5.5, 5,   4.5, 3, 2.5, 2.5, 2.5, 2.5, 15,  2.5, 2.5, 2.5, 15,  2.5, 2.5, 2.5, 15,  3,   3.5 ]; // RED
	const d1 = [ 2, 2, 2, 1.75, 1.5,  1.25, 0.5,  0.5, 1,   2, 3,    0.5, 2, 2.5, 3, 3.5,  3.5, 4, 4, 4, 4,  4, 4,  4, 4,  4.5, 4.5, 4.5, 4,   0, 0, 2.5,   2.5, 2.5, 2.5, 2.5, 15,  2.5, 2.5, 2.5, 15,  2.5, 2.5, 2.5, 2.5]; // BLUE
	const d2 = [ 2, 2, 2, 1,    1,    0.5,  0.5,  0.5, 0.5, 0, 0,    1,   1, 1,   1, 2.25, 3,   4, 4, 3, 2,  1, 1,  1, 1,  4,   3.5, 3.5, 3,   0, 0, 2.5,   2.5, 2.5, 15,  2.5, 2.5, 2.5, 15,  2.5, 2.5, 2.5, 15,  2.5, 2.5 ]; // GREEN
